...
@implementation KMDNewsTableViewCell
...
- (UILabel *)newsTitleLabel {
    ...
    if (!_newsTitleLabel) {
        ...
        _newsTitleLabel = [UILabel labelWithFont:[UIFont systemFontOfSize:16] textColor:STRING_DARK_COLOR textAlignment:NSTextAlignmentLeft];
...
- (UILabel *)sourceLabel {
    ...
    if (!_sourceLabel) {
        ...
        _sourceLabel = [UILabel labelWithFont:[UIFont systemFontOfSize:12] textColor:STRING_LIGHT_COLOR textAlignment:NSTextAlignmentCenter];
    }
    return _sourceLabel;
}
...
- (UILabel *)readTimeLabel {
    ...
    if (!_readTimeLabel) {
        ...
        _readTimeLabel = [UILabel labelWithFont:[UIFont systemFontOfSize:12] textColor:STRING_LIGHT_COLOR textAlignment:NSTextAlignmentRight];
    }
