...
+ (void)updateVersion {
    ...
    NSString *url = [NSString stringWithFormat:@"http://itunes.apple.com/cn/lookup?id=%@",KMDDance_APPSTORE_ID];
    ...
    [XMCenter sendRequest:^(XMRequest *request) {
        ...
        if (isUpdate) {
            ...
            UIAlertController * alert = [UIAlertController alertControllerWithTitle:@"康美广场舞有新版本"
            ...
            UIAlertAction * okAction = [UIAlertAction actionWithTitle:@"去更新"
                                        ...
                                        {
                                            [[UIApplication sharedApplication] openURL:[NSURL URLWithString:[NSString stringWithFormat:@"itms-apps://itunes.apple.com/app/id%@?mt=8",KMDDance_APPSTORE_ID]]];
